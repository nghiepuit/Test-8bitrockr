...
import styles from './create_address.styles.scss'
...
class CreateAddressContainer extends Component {
  ...
  onHandleSubmit = (e) => {
    ...
    if (isEmpty(this.onValidateForm())) {
      ...
      actions.changeNotify(NotifyConstants.NOTIFY_TYPE_SUCCESS, NotifyConstants.MSG_ADD_ADDRESS_TITLE, NotifyConstants.MSG_ADD_ADDRESS_SUCCESS)
    ...
    return (
      <Layout>
        <div className='container'>
          <h2 className='text-center text-danger'>Create Address</h2>
          <button
...
CreateAddressContainer.propTypes = {
...
})(connect(mapStateToProps, mapDispatchToProps)(CreateAddressContainer))
